...
end_step = inversion_steps * lambda_end
...
with torch.no_grad():
    ...
    x_rec = sampler.decode_with_low_FBS(ref_latent=latent, cond=cond, t_dec=sampling_steps,
    ...
    # x_rec = sampler.decode_with_high_FBS(ref_latent=latent, cond=cond, t_dec=sampling_steps,
    #                                      unconditional_guidance_scale=unconditional_guidance_scale,
    ...
    # x_rec = sampler.decode_with_mid_FBS(ref_latent=latent, cond=cond, t_dec=sampling_steps,
    #                                     unconditional_guidance_scale=unconditional_guidance_scale,
